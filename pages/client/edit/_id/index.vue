      ...
      <b-row>
        <b-col cols-md="3">
          <b-form-group
            ...
            class="text-left"
          >
            <b-form-select v-model="companyId" :options="options" />
          </b-form-group>
        </b-col>
        <b-col cols-md="4">
          <b-form-group
...
export default {
  ...
  methods: {
    async getCompany () {
      ...
      await this.$axios.$get(process.env.baseUrl + '/companies/', config).then((response) => {
        this.options = response.map((res) => {
    ...
    async getClient () {
      ...
      await this.$axios.$get(process.env.baseUrl + '/clients/' + id, config).then((response) => {
        ...
        this.personalNumber = response.personalNumber
